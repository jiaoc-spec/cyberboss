...
function readConfig() {
  ...
  return {
    ...
    followupInboxEnabled: readOptionalBoolEnv("CYBERBOSS_FOLLOWUP_INBOX_ENABLED") !== false,
    followupInboxStateFile: readTextEnv("CYBERBOSS_FOLLOWUP_INBOX_STATE_FILE") || path.join(stateDir, "followup-inbox.json"),
    followupInboxCheckIntervalMs: readIntEnv("CYBERBOSS_FOLLOWUP_INBOX_CHECK_INTERVAL_MS") || 300_000,
    followupInboxHour: readIntEnv("CYBERBOSS_FOLLOWUP_INBOX_HOUR") ?? 10,
    followupInboxMinute: readIntEnv("CYBERBOSS_FOLLOWUP_INBOX_MINUTE") ?? 0,
    followupInboxMaxItemsPerMessage: readIntEnv("CYBERBOSS_FOLLOWUP_INBOX_MAX_ITEMS_PER_MESSAGE") || 3,
    followupInboxRetentionDays: readIntEnv("CYBERBOSS_FOLLOWUP_INBOX_RETENTION_DAYS") || 180,
    ...
    habitCheckinEnabled: readOptionalBoolEnv("CYBERBOSS_HABIT_CHECKIN_ENABLED") !== false,
    habitCheckinStateFile: readTextEnv("CYBERBOSS_HABIT_CHECKIN_STATE_FILE") || path.join(stateDir, "habit-checkin-state.json"),
    habitCheckinCheckIntervalMs: readIntEnv("CYBERBOSS_HABIT_CHECKIN_CHECK_INTERVAL_MS") || 300_000,
    habitCheckinOffDayHour: readIntEnv("CYBERBOSS_HABIT_CHECKIN_OFF_DAY_HOUR") ?? 7,
    habitCheckinEarlyShiftHour: readIntEnv("CYBERBOSS_HABIT_CHECKIN_EARLY_SHIFT_HOUR") ?? 5,
    habitCheckinLateShiftHour: readIntEnv("CYBERBOSS_HABIT_CHECKIN_LATE_SHIFT_HOUR") ?? 7,
    habitCheckinNightShiftHour: readIntEnv("CYBERBOSS_HABIT_CHECKIN_NIGHT_SHIFT_HOUR") ?? 17,
