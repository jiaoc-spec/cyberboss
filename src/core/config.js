...
function readConfig() {
  ...
  return {
    ...
    today3x3DatabasePath: readTextEnv("CYBERBOSS_TODAY3X3_DATABASE_PATH") || path.join(os.homedir(), "Library/Group Containers/8774ZX9976.3x3.today/Model_3x3.sqlite/Model_3x3.sqlite"),
