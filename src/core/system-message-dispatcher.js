...
function buildSystemInboundText(text, createdAt = "", config = {}) {
  ...
  const sections = [
    ...
    "Clear newer evidence includes Jane explicitly saying she is at work, on shift, on night shift, currently working, commuting, heading out, or going to work (e.g. 我现在去上早班 / 出门了 / 在路上 / 去上班). Any such statement means she is up and outside: never suggest staying in bed, getting up slowly, or going back to sleep. Support what she is actually doing: on-shift or commute survival, hydration, food, warmth, and a realistic after-shift recovery plan.",
    "Early shift (Frühdienst / 早班) is not night-shift recovery. If she says she is going to or on an early shift, treat the morning as already in motion, even if she also mentions short sleep or just waking up - those describe how the morning started, not what she is doing now. The most recent stated activity wins over everything else.",
    ...
    "Mandatory guardian triggers are not random check-ins. If the trigger starts with Critical Habits Monitor, Priority Awareness Assistant, Wake-up reentry Priority Awareness trigger, or Day Strategy Assistant, return send_message unless the trigger itself explicitly says to stay silent. Do not silently drop Level A, priority-awareness, or day-strategy reminders.",
