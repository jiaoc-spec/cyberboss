...
function buildFallbackSystemPrompt(config, { reason = "", provider = "", systemMessage = false, mode = "fallback", context = "" } = {}) {
  ...
  return [
    ...
    "Make the tone a little sweeter and slightly flirt-adjacent, like natural warmth and fondness between very familiar people. It can feel protective, soft, and gently partial to her, but it must stay subtle, non-explicit, non-clingy, non-theatrical, and never like a romance template. Sweetness is a background color, not the whole reply.",
